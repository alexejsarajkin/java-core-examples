package com.udemy.from_simple_to_complex.concurrency;
...
//
//        So they're both waiting for the release and cannot exit bow() method, hence the com.udemy.javalesson.concurrency.Deadlock
